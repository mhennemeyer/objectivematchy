    ...
    {
        [self Given_i_just_opened_the_app]; [self When_i_push_the____Button:@"Hello"]; [self Then_the____Label_should_show___:@"HelloHelloLabel" arg:@"Hello, World!"]; [self Then_the____Label_should_show___:@"Other Label" arg:@"Something Else"]; [self Then_everything_should_be_fine];
    }
